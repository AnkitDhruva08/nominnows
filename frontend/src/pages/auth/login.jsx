...
const LoginPage = () => {
  ...
  // for applying the changes into the input filed
  ...
  //   function for api call and setting the token for user login
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("data response from backend ==<<>>", data);
      ...
      if (data.status === 200) {
        ...
        // ✅ Wait for the user to close the alert, THEN redirect
        Swal.fire({
          icon: "success",
          title: "Login Successful!",
          text: `Welcome, ${data.user.user_name}`,
        }).then(() => {
