...
const RegisterPage = () => {
  ...
  // function for fetching drop downdown data
...
// fetching roles dropdwon from backend 
  useEffect(() => {
    fecthData();
  }, []);

  // this is used for handle the chages of formdata
  ...
  // function for validate form field
    const validateForm = () => {
  ...
  // this will help to redirect regosterd through the third api 
      ...
      <div className="bg-white shadow-2xl rounded-3xl p-8 sm:p-10 w-full max-w-md transform transition-all duration-300 hover:scale-[1.01] hover:shadow-3xl">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full appearance-none bg-white border border-gray-300 rounded-xl px-4 py-3 pr-10 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-800 transition duration-200"
                >
        ...
        <div className="flex flex-col sm:flex-row justify-between space-y-3 sm:space-y-0 sm:space-x-3">
          ...
          >
            ...
            >
              <path
                d="M12.24 10.285V14.4H19.345C18.892 16.736 16.592 19.381 12.24 19.381C7.994 19.381 4.49 16.035 4.49 11.99C4.49 7.945 7.994 4.599 12.24 4.599C14.691 4.599 16.488 5.688 17.513 6.643L20.428 3.728C18.064 1.545 15.36 0 12.24 0C5.462 0 0 5.372 0 11.99C0 18.608 5.462 23.98 12.24 23.98C19.018 23.98 23.513 18.232 23.513 12.181C23.513 11.455 23.447 10.849 23.336 10.285H12.24V10.285Z"
                fill="#EA4335"
              />
              <path
                d="M0 11.99L4.49 11.99C4.49 14.331 6.302 16.299 8.643 16.299C9.72 16.299 10.702 15.918 11.488 15.341L14.4 18.256C12.981 19.333 10.681 19.98 8.643 19.98C5.234 19.98 2.22 17.513 0 14.597L0 11.99Z"
                fill="#34A853"
              />
              <path
                d="M12.24 4.091C13.622 4.091 14.881 4.582 15.863 5.49L18.778 2.575C17.027 1.053 14.636 0 12.24 0C8.831 0 5.817 2.467 3.595 5.383L7.108 7.97C8.016 5.864 9.974 4.091 12.24 4.091Z"
                fill="#FBBC04"
              />
              <path
                d="M23.513 12.181L23.336 10.285H12.24V14.4H19.345C19.259 14.869 19.141 15.421 18.892 16.035C20.655 14.629 21.848 13.567 23.513 12.181Z"
                fill="#4285F4"
              />
            </svg>
            Google
          ...
          >
            ...
            >
              <path
                d="M9 20V14H6V10H9V8C9 4.71 10.667 3 14.5 3C16.167 3 17.5 3.167 18 3.333V7H15C13.833 7 13 7.5 13 8.5V10H18L17 14H13V20H9Z"
                fill="#3B5998"
              />
            </svg>
            Facebook
